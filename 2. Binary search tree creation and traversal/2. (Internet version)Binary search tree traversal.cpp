/* 
    Key points:-
    1. Default type of class members are private.
    2. private members are not accessible outside the class.
    3. Private variables can only be accessed through the member functions of that class.
*/
#include<iostream>
using namespace std;
...
class bst{
    bintree_node *root; //Can only be accessed by insert(), displayBinTree() and printBinTree() fuctions.
    public:
    bst(){
        root=NULL;
    }
